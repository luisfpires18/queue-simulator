...
import { sumGraphSeries, buildHealthCurve, timeAtHealthPct, resolveBossActor } from '../src/server/parse/bossHealth.js';
import { truncateSeries, truncateDetail } from '../src/server/analysis/truncate.js';
