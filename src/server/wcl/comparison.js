...
export async function buildComparison({
  ...
  // Default opponent: the #1-ranked player - the same entry the dropdown
  // shows first. (Used to default to whoever's clear time was closest to
  // mine, which has zero correlation with rank and could silently preselect
  // any position on the page.)
  let selected = topPlayers[0] ?? withMatch[0];
